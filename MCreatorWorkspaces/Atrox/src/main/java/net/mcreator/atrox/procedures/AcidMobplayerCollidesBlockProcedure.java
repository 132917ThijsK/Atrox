...
public class AcidMobplayerCollidesBlockProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof SpookyBoatEntity || entity instanceof SpookyroamerEntity || entity.isPassenger() || entity instanceof LivingEntity _livEnt3 && _livEnt3.hasEffect(AtroxModMobEffects.ACIDIC.get())) {
