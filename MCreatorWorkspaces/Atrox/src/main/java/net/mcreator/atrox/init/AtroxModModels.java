...
import net.mcreator.atrox.client.model.Modelweepingangelcracked;
...
public class AtroxModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(Modelweepingangelcracked.LAYER_LOCATION, Modelweepingangelcracked::createBodyLayer);
