...
public class Modelspookyboat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "spookyboat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = front.addOrReplaceChild("base",
				CubeListBuilder.create().texOffs(0, 0).addBox(-14.0F, -8.0F, -1.5F, 28.0F, 16.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5F, 4.0F, 1.5708F, 1.5708F, 0.0F));
