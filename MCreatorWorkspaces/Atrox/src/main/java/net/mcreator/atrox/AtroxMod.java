...
@Mod("atrox")
public class AtroxMod {
	public static final Logger LOGGER = LogManager.getLogger(AtroxMod.class);
	public static final String MODID = "atrox";
	...
	public AtroxMod() {
		...
		AtroxModParticleTypes.REGISTRY.register(bus);
