...
import net.mcreator.atrox.procedures.BoossmallfireballwhileprojectileflyingtickProcedure;
import net.mcreator.atrox.procedures.BoossmallfireballprojectilehitslivingentityProcedure;
...
public class BoossmallfireballprojectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		BoossmallfireballprojectilehitslivingentityProcedure.execute(this.level(), entityHitResult.getEntity());
	}

	@Override
	public void tick() {
		super.tick();
		BoossmallfireballwhileprojectileflyingtickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
		if (this.inGround)
			this.discard();
	}
