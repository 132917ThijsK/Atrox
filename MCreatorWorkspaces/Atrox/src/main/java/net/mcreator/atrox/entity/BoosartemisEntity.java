...
import net.mcreator.atrox.procedures.BoosartemisoninitialentityspawnProcedure;
import net.mcreator.atrox.procedures.BoosartemisiaProcedure;
...
public class BoosartemisEntity extends Monster {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		BoosartemisoninitialentityspawnProcedure.execute(this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		BoosartemisiaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
