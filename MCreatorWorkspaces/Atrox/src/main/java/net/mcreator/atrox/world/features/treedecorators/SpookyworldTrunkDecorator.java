...
public class SpookyworldTrunkDecorator extends TrunkVineDecorator {
	public static Codec<SpookyworldTrunkDecorator> CODEC = Codec.unit(SpookyworldTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("spookyworld_tree_trunk_decorator", DECORATOR_TYPE));
	}
